...
public class BidListController {
    ...
    public boolean addBid(Bid bid){
        AddBidCommand add_bid_command = new AddBidCommand(bid_list, bid);
        add_bid_command.execute();
        return add_bid_command.isExecuted();
    }

    public boolean removeBid(Bid bid) {
        DeleteBidCommand delete_bid_command = new DeleteBidCommand(bid_list, bid);
    ...
    public boolean removeItemBids(String id) {
        ...
        for (Bid b : old_bids) {
            delete_bid_command = new DeleteBidCommand(bid_list, b);
            delete_bid_command.execute();
